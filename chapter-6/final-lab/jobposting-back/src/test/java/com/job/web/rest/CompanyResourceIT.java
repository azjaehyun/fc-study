...
class CompanyResourceIT {
    ...
    void putExistingCompany() throws Exception {
        ...
        restCompanyMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCompany.getCompanyId())
    ...
    void putNonExistingCompany() throws Exception {
        ...
        restCompanyMockMvc
            .perform(
                put(ENTITY_API_URL_ID, company.getCompanyId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.address(UPDATED_ADDRESS);
    ...
    void patchNonExistingCompany() throws Exception {
        ...
        restCompanyMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, company.getCompanyId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(company))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteCompany() throws Exception {
        ...
        // Delete the company
        restCompanyMockMvc
            .perform(delete(ENTITY_API_URL_ID, company.getCompanyId()).accept(MediaType.APPLICATION_JSON))
