...
export const Application = () => {
  ...
  const [paginationState, setPaginationState] = useState(
    overridePaginationStateWithQueryParams(getSortState(location, ITEMS_PER_PAGE, 'applicationId'), location.search)
  );
  ...
  return (
    <div>
      <h2 id="application-heading" data-cy="ApplicationHeading">
        <Translate contentKey="jobpostingApp.application.home.title">Applications</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jobpostingApp.application.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/application/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jobpostingApp.application.home.createLabel">Create new Application</Translate>
          </Link>
        </div>
      </h2>
        ...
        {applicationList && applicationList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('applicationId')}>
                  <Translate contentKey="jobpostingApp.application.applicationId">Application Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="jobpostingApp.application.applicant">Applicant</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/application/${application.applicationId}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/application/${application.applicationId}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jobpostingApp.application.home.notFound">No Applications found</Translate>
            </div>
          )
        )}
      </div>
