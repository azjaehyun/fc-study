    ...
    <Row>
      <Col md="8">
        <h2 data-cy="resumeDetailsHeading">
          <Translate contentKey="jobpostingApp.resume.detail.title">Resume</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="resumeId">
              <Translate contentKey="jobpostingApp.resume.resumeId">Resume Id</Translate>
            </span>
          </dt>
          <dd>{resumeEntity.resumeId}</dd>
          <dt>
            <span id="title">
              <Translate contentKey="jobpostingApp.resume.title">Title</Translate>
            </span>
          </dt>
          <dd>{resumeEntity.title}</dd>
          <dt>
            <span id="content">
              <Translate contentKey="jobpostingApp.resume.content">Content</Translate>
            </span>
          </dt>
          <dd>{resumeEntity.content}</dd>
          <dt>
            <span id="submittedDate">
              <Translate contentKey="jobpostingApp.resume.submittedDate">Submitted Date</Translate>
            </span>
          </dt>
          <dd>
