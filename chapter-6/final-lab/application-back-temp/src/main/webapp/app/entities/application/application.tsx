  ...
  return (
    <div>
      <h2 id="application-heading" data-cy="ApplicationHeading">
        <Translate contentKey="applicationApp.application.home.title">Applications</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="applicationApp.application.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/application/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="applicationApp.application.home.createLabel">Create new Application</Translate>
          </Link>
        </div>
      </h2>
        ...
        {applicationList && applicationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="applicationApp.application.resume">Resume</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="applicationApp.application.home.notFound">No Applications found</Translate>
            </div>
          )
        )}
      </div>
