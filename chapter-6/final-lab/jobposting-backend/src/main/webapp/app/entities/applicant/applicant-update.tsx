  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jobpostingApp.applicant.home.createOrEditLabel" data-cy="ApplicantCreateUpdateHeading">
            <Translate contentKey="jobpostingApp.applicant.home.createOrEditLabel">Create or edit a Applicant</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  label={translate('jobpostingApp.applicant.applicantId')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jobpostingApp.applicant.name')}
                id="applicant-name"
                name="name"
                data-cy="name"
                type="text"
              />
              <ValidatedField
                label={translate('jobpostingApp.applicant.email')}
                id="applicant-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('jobpostingApp.applicant.phone')}
                id="applicant-phone"
                name="phone"
                data-cy="phone"
                type="text"
