...
export const ApplicationDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(applicationEntity.applicationId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jobpostingApp.application.delete.question">
        <Translate contentKey="jobpostingApp.application.delete.question" interpolate={{ id: applicationEntity.applicationId }}>
