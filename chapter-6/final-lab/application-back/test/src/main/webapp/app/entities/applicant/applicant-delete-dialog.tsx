...
export const ApplicantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="applicationApp.applicant.delete.question">
        <Translate contentKey="applicationApp.applicant.delete.question" interpolate={{ id: applicantEntity.applicantId }}>
