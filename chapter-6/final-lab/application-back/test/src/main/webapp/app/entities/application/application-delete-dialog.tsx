...
export const ApplicationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="applicationApp.application.delete.question">
        <Translate contentKey="applicationApp.application.delete.question" interpolate={{ id: applicationEntity.applicationId }}>
