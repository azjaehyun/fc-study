    ...
    <Row>
      <Col md="8">
        <h2 data-cy="applicantDetailsHeading">
          <Translate contentKey="applicationApp.applicant.detail.title">Applicant</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="applicantId">
              <Translate contentKey="applicationApp.applicant.applicantId">Applicant Id</Translate>
            </span>
          </dt>
          <dd>{applicantEntity.applicantId}</dd>
          <dt>
            <span id="name">
              <Translate contentKey="applicationApp.applicant.name">Name</Translate>
            </span>
          </dt>
          <dd>{applicantEntity.name}</dd>
          <dt>
            <span id="email">
              <Translate contentKey="applicationApp.applicant.email">Email</Translate>
            </span>
          </dt>
          <dd>{applicantEntity.email}</dd>
          <dt>
            <span id="phone">
              <Translate contentKey="applicationApp.applicant.phone">Phone</Translate>
            </span>
          </dt>
