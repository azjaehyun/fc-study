...
class ApplicationResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{applicationId}";
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application().applicationDate(DEFAULT_APPLICATION_DATE);
        return application;
    }
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application().applicationDate(UPDATED_APPLICATION_DATE);
        return application;
    }
    ...
    void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc
            .perform(get(ENTITY_API_URL + "?sort=applicationId,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].applicationId").value(hasItem(application.getApplicationId().intValue())))
    ...
    void getApplication() throws Exception {
        ...
        // Get the application
        restApplicationMockMvc
            .perform(get(ENTITY_API_URL_ID, application.getApplicationId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.applicationId").value(application.getApplicationId().intValue()))
    ...
    void putExistingApplication() throws Exception {
        ...
        Application updatedApplication = applicationRepository.findById(application.getApplicationId()).get();
        ...
        updatedApplication.applicationDate(UPDATED_APPLICATION_DATE);

        restApplicationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedApplication.getApplicationId())
    ...
    void putNonExistingApplication() throws Exception {
        int databaseSizeBeforeUpdate = applicationRepository.findAll().size();
        application.setApplicationId(count.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restApplicationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, application.getApplicationId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.setApplicationId(application.getApplicationId());

        restApplicationMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedApplication.getApplicationId())
    ...
    void fullUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.applicationDate(UPDATED_APPLICATION_DATE);
    ...
    void patchNonExistingApplication() throws Exception {
        ...
        restApplicationMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, application.getApplicationId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(application))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteApplication() throws Exception {
        ...
        restApplicationMockMvc
            .perform(delete(ENTITY_API_URL_ID, application.getApplicationId()).accept(MediaType.APPLICATION_JSON))
