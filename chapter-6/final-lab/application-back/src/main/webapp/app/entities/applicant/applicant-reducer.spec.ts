...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_APPLICANT actions', async () => {
      ...
      await store.dispatch(createEntity({ applicantId: 456 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
    ...
    it('dispatches UPDATE_APPLICANT actions', async () => {
      ...
      await store.dispatch(updateEntity({ applicantId: 456 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });
    ...
    it('dispatches PARTIAL_UPDATE_APPLICANT actions', async () => {
      ...
      await store.dispatch(partialUpdateEntity({ applicantId: 123 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });
