  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.jobPosting.home.createOrEditLabel" data-cy="JobPostingCreateUpdateHeading">
            <Translate contentKey="myApp.jobPosting.home.createOrEditLabel">Create or edit a JobPosting</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  label={translate('myApp.jobPosting.jobId')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('myApp.jobPosting.title')} id="job-posting-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('myApp.jobPosting.description')}
              ...
              />
              <ValidatedField
                label={translate('myApp.jobPosting.location')}
              ...
              />
              <ValidatedField
                label={translate('myApp.jobPosting.postedDate')}
