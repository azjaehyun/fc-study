  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.resume.home.createOrEditLabel" data-cy="ResumeCreateUpdateHeading">
            <Translate contentKey="myApp.resume.home.createOrEditLabel">Create or edit a Resume</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="resume-resumeId"
                  label={translate('myApp.resume.resumeId')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('myApp.resume.title')} id="resume-title" name="title" data-cy="title" type="text" />
              <ValidatedField label={translate('myApp.resume.content')} id="resume-content" name="content" data-cy="content" type="text" />
              <ValidatedField
                label={translate('myApp.resume.submittedDate')}
              ...
              <ValidatedField
                ...
                name="applicant"
                data-cy="applicant"
                label={translate('myApp.resume.applicant')}
                type="select"
              >
                <option value="" key="0" />
                {applicants
