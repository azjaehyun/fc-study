...
import com.myapp.repository.JobPostingRepository;
...
/**
 * REST controller for managing {@link com.myapp.domain.JobPosting}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobPostingResource {
    ...
    public List<JobPosting> getAllJobPostings() {
        log.debug("REST request to get all JobPostings");
