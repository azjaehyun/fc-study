...
export const ApplicantResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllApplicants: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/applicants`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ApplicantResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllApplicants(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Applicant>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllApplicants(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const ApplicantResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllApplicants(options?: any): AxiosPromise<Array<Applicant>> {
            return localVarFp.getAllApplicants(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} id 
...
export class ApplicantResourceApi extends BaseAPI {
     ...
     * @memberof ApplicantResourceApi
     */
    public getAllApplicants(options?: AxiosRequestConfig) {
        return ApplicantResourceApiFp(this.configuration).getAllApplicants(options).then((request) => request(this.axios, this.basePath));
    }
...
export const ApplicationResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllApplications: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/applications`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ApplicationResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllApplications(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Application>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllApplications(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const ApplicationResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getAllApplications(options?: any): AxiosPromise<Array<Application>> {
            return localVarFp.getAllApplications(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} id 
...
export class ApplicationResourceApi extends BaseAPI {
    ...
    public getAllApplications(options?: AxiosRequestConfig) {
        return ApplicationResourceApiFp(this.configuration).getAllApplications(options).then((request) => request(this.axios, this.basePath));
    }
...
export const JobPostingResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllJobPostings: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/job-postings`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const JobPostingResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllJobPostings(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<JobPosting>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllJobPostings(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const JobPostingResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllJobPostings(options?: any): AxiosPromise<Array<JobPosting>> {
            return localVarFp.getAllJobPostings(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} id 
...
export class JobPostingResourceApi extends BaseAPI {
     ...
     * @memberof JobPostingResourceApi
     */
    public getAllJobPostings(options?: AxiosRequestConfig) {
        return JobPostingResourceApiFp(this.configuration).getAllJobPostings(options).then((request) => request(this.axios, this.basePath));
    }
...
export const ResumeResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllResumes: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/resumes`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ResumeResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllResumes(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Resume>>> {
...
export const ResumeResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllResumes(options?: any): AxiosPromise<Array<Resume>> {
...
export class ResumeResourceApi extends BaseAPI {
     ...
     * @memberof ResumeResourceApi
     */
    public getAllResumes(options?: AxiosRequestConfig) {
        return ResumeResourceApiFp(this.configuration).getAllResumes(options).then((request) => request(this.axios, this.basePath));
    }
